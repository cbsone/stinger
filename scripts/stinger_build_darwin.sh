...
[[ "${OS_MIN}" -lt 14 ]] && echo "You must be running Mac OS 10.14.x or higher to install Stinger." && exit 1
...
ensure-brew-packages "${REPO_ROOT}/scripts/stinger_build_darwin_deps"
