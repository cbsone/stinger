...
string default_wallet_url = "unix://" + (determine_home_directory() / "stinger-wallet" / (string(key_store_executable_name) + ".sock")).string();
...
int main( int argc, char** argv ) {
   ...
   CLI::App app{"Command Line Interface to Stinger Client"};
