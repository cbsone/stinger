...
There are several ways to configure a `stnode` environment for development and testing. Which option to use largely depends on what the project goals are. Some practical options are provided below.
...
* [Configure Nodeos as a Local 21-Node Testnet](https://github.com/Stinger/eos/blob/master/tutorials/bios-boot-tutorial/README.md)

## Official Testnet

The official testnet is available for testing Stinger dApps and smart contracts:

* [testnet.eos.io](https://testnet.eos.io/)

## Third-Party Testnets

The following third-party testnets are available for testing Stinger dApps and smart contracts:
