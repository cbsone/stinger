...
[[info | More Info]]
| See HISTORY section of [RPC API](https://developers.eos.io/eosio-stnode/reference).
...
```sh
# command-line
stnode ... --plugin eosio::history_api_plugin
```
...
```sh
# command-line
stnode ... --plugin eosio::history_plugin [options]  \
