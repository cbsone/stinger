...
```sh
# command-line
stnode ... --plugin eosio::trace_api_plugin [options]
```
...
```sh
# command-line
stnode ... --plugin eosio::chain_plugin [options]  \
           --plugin eosio::http_plugin [options]
```

## Configuration Example

Here is a `stnode` configuration example for the `trace_api_plugin` when tracing some Stinger reference contracts:

```sh
stnode --data-dir data_dir --config-dir config_dir --trace-dir traces_dir
--plugin eosio::trace_api_plugin 
