...
```sh
# command-line
stnode ... --plugin eosio::state_history_plugin [operations] [options]
```

## Operations

These can only be specified from the `stnode` command-line:
...
### history-tools
  ...
  * [Source code](https://github.com/Stinger/history-tools/)
...
```sh
# command-line
stnode ... --plugin eosio::chain_plugin --disable-replay-opts
```
