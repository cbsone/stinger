...
This section contains shell commands to manually download, build, install, test, and uninstall Stinger and dependencies on Ubuntu 18.04.
...
## Test Stinger
These commands validate the Stinger software installation on the specified OS. Make sure to [Install Stinger](#install-eosio) first. (**Note**: This task is optional but recommended.)
```sh
